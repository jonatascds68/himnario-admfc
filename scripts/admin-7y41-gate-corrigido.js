...
const ADMFC_7Y41_OFFICIAL_SIMULATED_BASE =
  'assets/base_mestre.OFICIAL-SIMULADA-7Y41.json';
...
if (!baseFile || !packageFile) {
  ...
  if (!process.exitCode) {
    ...
    if (
       ...
       */
      if (baseFile === "assets/base_mestre.OFICIAL-SIMULADA-7Y41.json") {
        /*
         * PROTÓTIPO 7Y.2:
         *
    ...
    if (
      baseFile === "assets/base_mestre.OFICIAL-SIMULADA-7Y41.json"
    ) {
      console.log(
        'CHECKPOINT OFICIAL:',
