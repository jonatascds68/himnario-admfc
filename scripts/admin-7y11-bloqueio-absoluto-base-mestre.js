  ...
  if (!process.exitCode) {
    ...
    if (
      ...
      if (baseFile === "assets/base_mestre.json") {
        /*
         * ADMFC 7Y.11:
         * isolamento absoluto da Base Mestre.
         *
         * Nenhuma autorização é suficiente nesta etapa.
         * O objetivo é provar que a Base Mestre não alcança
         * mais a rota genérica de escrita.
         */
        console.error(
          'BLOQUEADO: escrita na Base Mestre oficial desabilitada pelo gate 7Y.11.'
        );
