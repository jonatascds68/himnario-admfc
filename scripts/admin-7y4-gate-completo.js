/*
 * ADMFC_7Y4_FULL_OFFICIAL_GATE
 * Gate integrado de autorização oficial.
 * Exclusivamente para base oficial simulada.
 */
const fs = require('fs');
...
if (!baseFile || !packageFile) {
  ...
  if (!process.exitCode) {
    ...
    if (
       ...
       */
      if (baseFile === "assets/base_mestre.OFICIAL-SIMULADA-7Y31.json") {
        /*
         * PROTÓTIPO 7Y.2:
         *
    ...
    if (
      baseFile === "assets/base_mestre.OFICIAL-SIMULADA-7Y31.json"
    ) {
      console.log(
