/* ADMFC_7Y14_OFFICIAL_REAL_CANDIDATE */
/*
...
if (!baseFile || !packageFile) {
  ...
  if (!process.exitCode) {
    ...
    if (
       ...
       */
      if (baseFile === "assets/base_mestre.SOMBRA-7Y15.json") {
        /*
         * ADMFC 7Y.12:
        ...
        if (!authorizeOfficial) {
          ...
          console.log(
            'AUTORIZAÇÃO DA BASE MESTRE OFICIAL: RECONHECIDA'
          );
          ...
          if (
            ...
            console.log(
              'COMMIT ATÔMICO DA BASE MESTRE: EXECUTADO'
            );
    ...
    if (
      (
        ...
        baseFile === "assets/base_mestre.SOMBRA-7Y15.json"
      )
    ) {
      console.log(
        'CHECKPOINT OFICIAL:',
